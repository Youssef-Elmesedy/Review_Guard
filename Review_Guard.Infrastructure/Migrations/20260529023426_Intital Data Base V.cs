        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserActivities_Admins_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodRating = table.Column<decimal>(type: "decimal(3,2)", precision: 3, scale: 2, nullable: false),
                    ServiceRating = table.Column<decimal>(type: "decimal(3,2)", precision: 3, scale: 2, nullable: false),
                    CleanlinessRating = table.Column<decimal>(type: "decimal(3,2)", precision: 3, scale: 2, nullable: false),
                    AmbienceRating = table.Column<decimal>(type: "decimal(3,2)", precision: 3, scale: 2, nullable: false),
                    ValueRating = table.Column<decimal>(type: "decimal(3,2)", precision: 3, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "MediaAssets",
                columns: new[] { "BranchId", "IsPrimary" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserActivities_AdminId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VerificationCodes_UserId_Type_Code",
                table: "VerificationCodes",
                columns: new[] { "UserId", "Type", "Code" });
        }
